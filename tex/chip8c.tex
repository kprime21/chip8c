...
\section*{Main}
\begin{itemize}
	\item emulator is now working, slowly and faulty but working
	\item look over opcodes once more
	\item work on graphics display method (scale resolution in SDL)
\end{itemize}
